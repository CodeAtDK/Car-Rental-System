...
int line_number;
    ...
    if(lines.size() == 0){
        ...
        cout<<"SUV are Not Available"<<endl;
        cout<<"Please selecte the different car type"<<endl;
        car();
        exit(0);
    }
...
class rent : public car{
        ...
        int arrofmonth[] = {31,28,31,30,31,30,31,31,30,31,30,31};
            ...
            if(31 == arrofmonth[ltm->tm_mon]){
                ...
                if(return_time > 30){
                    ...
                    ltm->tm_mday = return_time;
                }
    
            }
            else if(30 == arrofmonth[ltm->tm_mon]){
            ...
            else if(28 == arrofmonth[ltm->tm_mon]){
   ...
   rentedcars.append("rented");
    ...
    cout<<"Enter the  adhare Number"<<endl;
    cin>>adhare;
    
    cout<<"Enter the Driving Licences Number"<<endl;
    cin>>Driving_lis;
    rent<<adhare<<endl;
    rent<<Driving_lis<<endl;
